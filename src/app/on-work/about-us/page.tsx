        ...
        <div className="bg-gray-100 border border-gray-300 rounded-lg p-8 md:p-12 w-full">
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
              <PartnerLogo imageSrc="/assets/partners/empyreanpropertymanagement.png" name="Empyrean Brokerage Arm" />
              <PartnerLogo imageSrc="/assets/partners/empyreanrealestate.png" name="Empyrean Property Management Arm" />
