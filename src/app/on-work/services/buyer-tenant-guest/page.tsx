    ...
    <main className="min-h-screen flex flex-col">
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <p className="text-[14px] md:text-lg text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-[14px] md:text-lg text-center mb-12 max-w-4xl mx-auto"> You will be assigned with a <span className="font-bold">Relationship Manager</span> to search the market for you with our In-House Sellers and our Broker Circle to get started. They shall also be the one who will handle your account with us and attend to all your inquiries in accessing our Empyrean Business Network and Professional Circles or concerns regarding your properties.
        </p>
